...
var (
	...
	//
	// Value is binary signature.PublicKey (node ID).
	beaconPointMapKeyFmt = keyformat.New(0x1a, keyformat.H(&scrape.Point{}))
)
...
func (s *ImmutableState) NodeByBeaconPoint(ctx context.Context, point scrape.Point) (*node.Node, error) {
